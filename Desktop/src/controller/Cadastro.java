...
public class Cadastro{
    ...
    public void cadastrarUsuario(ActionEvent event) {
    	if (UsuarioController.cadastrarUsuario(textFieldNome.getText(), textFielSobrenome.getText(), textFieldCPF.getText(),
    			textFieldTelefone.getText(), passwordFieldCadastroSenha.getText(), passwordFieldConfirmeSenha.getText(), textFieldCadastroEmail.getText())) {
    		TelaController.exibirJanela(AlertType.INFORMATION, Cadastro.tituloTelaCadastroUsuario,
    				"Operação realizada", "Novo usuário cadastrado com sucesso! Nome: " + textFieldNome.getText());
    		limparCamposCadastro();
    	} else {
    		TelaController.exibirJanela(AlertType.ERROR, Cadastro.tituloTelaCadastroUsuario, "Erro!",
    ...
    public void carregarTelaInicial(ActionEvent event) {
    	TelaController.carregarTela(event, "/application/TelaInicial.fxml", Login.tituloTelaInicial);
    }
