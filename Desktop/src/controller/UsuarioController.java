...
public class UsuarioController {
	...
	private static boolean camposPreenchidos(String nome, String sobrenome, String email, String senha,
			String confirmarSenha, String cpf, String telefone) {
		return (!nome.trim().isEmpty() && !sobrenome.trim().isEmpty() && !email.trim().isEmpty()
				&& !senha.trim().isEmpty() && !confirmarSenha.trim().isEmpty() && !cpf.trim().isEmpty());
	}
	...
	public static boolean autenticarUsuario(String senha, String email) {
		for (Pessoa u : conjuntoUsuarios) { // percorre a lista de usuários para encontrar o nome equivalente ao do
											// parâmetro
